...
<%@page import="Entidad.Biblioteca"%>
...
<html>
    <head>
        ...
        <title>Mant. Bibliotecas | Vamos al Museo</title>
        <meta charset="utf-8">
					...
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
                                                                            <h1><CENTER>Mantenimiento de Bibliotecas</CENTER></h1>
									</header>
                                                                        ...
                                                                        <table class="alt">      
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th style="width:12%"><center>Codigo Destino</center></th>
                                                                    ...
                                                                    <%
                                                                                                ArrayList<Biblioteca> lista = Negocio.ListadoBiblioteca();
                                                                         ...
                                                                         %>     
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><%= B.getId_des() %></td>
                                                                                    <td><%= B.getCosto_bi() %></td>
                                                                                    <td><%= B.getHorario_bi() %></td>
                                                                                    <td align="center"><center><a href='EliminaBiblio.jsp?x=<%=B.getId_bi() %>' <button type="submit" class="btn btn-danger">Eliminar</button></a></center></td>
                                                                                    <td align="center"><center><a href='ModificaBiblio.jsp?a=<%=B.getId_bi() %>&b=<%=B.getId_des() %>&c=<%=B.getCosto_bi() %>&d=<%=B.getHorario_bi() %>' <button type="submit" class="btn btn-warning">Modificar</button></a></center></td>
                                                                             </tr>      
     <%
    }
    ...
    %>
                                                                            ...
                                                                            <tr>
                                                                                <td><center><div class="form-group"> <input type="text" class="form-control" id="id" name="id" placeholder="B####" value="" form="my_form" > </div></center></td>
                                                                                ...
                                                                                <td><center><div class="form-group"> <input type="text" class="form-control" id="cos" name="co" placeholder="Costo" value="" form="my_form" > </div></center></td>
                                                                                <td><center><div class="form-group"> <input type="text" class="form-control" id="hor" name="ho" placeholder="Horario" value="" form="my_form" > </div></center></td>
					...
					<div id="sidebar" class="inactive">
						<div class="inner">
							...
							<!-- Footer -->
                                ...
                                <form action="ins_biblio"  name="ins_biblio" method="GET" id="my_form"> </form>
