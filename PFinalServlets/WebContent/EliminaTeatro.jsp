...
<html>
    <head>
        ...
        <title>Elimina Teatro | Vamos al Museo</title>
        <meta charset="utf-8">
...
<body>
    <div class="container">
        <h1>Elimina Teatro</h1>
    <br>
    <form action="eli_teatro" name="eli_teatro" method="get">
      ...
      <button type="submit" name="btnconsultar" class="btn btn-danger">Eliminar teatro</button>
