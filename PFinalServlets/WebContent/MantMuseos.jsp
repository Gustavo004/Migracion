...
<html>
    <head>
        ...
        <title>Mant. Museos | Vamos al Museo</title>
        <meta charset="utf-8">
					...
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
                                                                            <h1><CENTER>Mantenimiento de Museos</CENTER></h1>
                                                                        </header>
                                                                    ...
                                                                    <div class="table-wrapper" style="margin:0.2cm 0.5cm 1cm 3cm;">
                                                                        <table class="alt">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th><center>Codigo Museo</center></th>
                                                                   ...
                                                                   <%
                                                                                               ArrayList<Museo> lista = Negocio.ListadoMuseo();
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td><%= M.getId_mus() %></td>
                                                                                <td><%= M.getId_des() %></td>
                                                                                <td><%= M.getCosto_mus() %></td>
                                                                                <td><%= M.getHorario_mus() %></td>
                                                                                <td align="center"><center><a href='EliminaMuseo.jsp?x=<%=M.getId_mus() %>' <button type="submit" class="btn btn-danger">Eliminar</button></a></center></td>
                                                                                <td align="center"><center><a href='ModificaMuseo.jsp?a=<%=M.getId_mus() %>&b=<%=M.getId_des() %>&c=<%=M.getCosto_mus() %>&d=<%=M.getHorario_mus() %>' <button type="submit" class="btn btn-warning">Modificar</button></a></center></td>
                                                                         </tr>      
                                                                        <%
                                                                       }
                                                                       ...
                                                                       %>
                                                                           ...
                                                                           <tr>
                                                                               <td><center><div class="form-group"> <input type="text" class="form-control" id="id" name="id" placeholder="M####" value="" form="my_form" > </div></center></td>
    ...
    <form action="ins_museo"  name="ins_museo" method="GET" id="my_form"> </form>  
