...
<html>
    <head>
        ...
        <title>Elimina Destino | Vamos al Museo</title>
        <meta charset="utf-8">
...
<body>
    <div class="container">
        <h1>Elimina Destino</h1>
    <br>
    <form action="eli_dest" name="eli_dest" method="get">
      ...
      <button type="submit" name="btnconsultar" class="btn btn-danger">Eliminar destino</button>
